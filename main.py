...
class SNILSValidator:
    ...
    СНИЛС (Страховой номер индивидуального лицевого счёта) имеет формат:
    XXX-XXX-XXX YY, где:
    - XXX-XXX-XXX - 9 цифр, разделенных дефисами
    - YY - 2 цифры контрольной суммы
    """

    # Регулярное выражение для поиска СНИЛС
    # Формат: XXX-XXX-XXX YY или XXX-XXX-XXXYY
